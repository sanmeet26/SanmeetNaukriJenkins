...
public final class TestData {
    ...
    // ===================== USER DATA =====================
    public static final String USERNAME = ConfigReader.getCredential("NAUKRI_EMAIL");
    public static final String PASSWORD = ConfigReader.getCredential("NAUKRI_PASSWORD");
    // ===================== RESUME DATA =====================
